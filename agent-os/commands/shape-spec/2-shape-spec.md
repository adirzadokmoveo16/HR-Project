...
1. **Read Initial Idea**: Load the raw idea from raw-idea.md
...
Read the raw idea from `[spec-path]/planning/raw-idea.md` to understand what the user wants to build.
